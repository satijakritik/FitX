    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'speed':
          ...
          break;
        case 'swim':
          result.swim = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int?;
          break;
        case 'points':
          ...
          break;
        case 'daily_steps':
          result.dailySteps = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int?;
          break;
        case 'sleep':
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  double? _spo2;
  double? get spo2 => _$this._spo2;
  set spo2(double? spo2) => _$this._spo2 = spo2;

  int? _strength;
  int? get strength => _$this._strength;
  set strength(int? strength) => _$this._strength = strength;
  ...
  int? _swim;
  int? get swim => _$this._swim;
  set swim(int? swim) => _$this._swim = swim;
  ...
  int? _dailySteps;
  int? get dailySteps => _$this._dailySteps;
  set dailySteps(int? dailySteps) => _$this._dailySteps = dailySteps;

  int? _sleep;
  int? get sleep => _$this._sleep;
  set sleep(int? sleep) => _$this._sleep = sleep;
