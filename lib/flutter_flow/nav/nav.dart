...
class AppStateNotifier extends ChangeNotifier {
  FitXFirebaseUser? initialUser;
  FitXFirebaseUser? user;
  ...
  void update(FitXFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'Exercise',
              path: 'exercise',
              builder: (context, params) => ExerciseWidget(),
            ),
            FFRoute(
              name: 'Home',
              path: 'home',
              builder: (context, params) => params.isEmpty
                  ...
                  : HomeWidget(
                      userPhoto: params.getParam('userPhoto',
            ...
            FFRoute(
              name: 'Soon',
              path: 'soon',
              builder: (context, params) => SoonWidget(),
            ),
            FFRoute(
              name: 'SoonCopy',
              path: 'soonCopy',
              builder: (context, params) => SoonCopyWidget(),
            )
